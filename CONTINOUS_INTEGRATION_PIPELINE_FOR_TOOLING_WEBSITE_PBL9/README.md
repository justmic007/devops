...
In our project we are going to utilize Jenkins CI capabilities to make sure that every change made to the source code in GitHub [https://github.com/justmic007/tooling](https://github.com/justmic007/tooling) will be automatically be updated to the Tooling Website.
